<section>
    ...
    <!-- START REVOLUTION SLIDER 5.0 auto mode -->
        <div id="slider-h2" class="rev_slider slider-home-1" data-version="5.0">
            <ul>
                ...
                {{-- <li data-transition="parallaxtoright" data-masterspeed="1000" >
                    ...
                    <!-- MAIN IMAGE -->
                    <img src="{{url('/')}}/uploads/sliders/carbinet.jpg"  alt="" data-bgposition="center center" data-bgfit="cover" data-bgrepeat="no-repeat" data-bgparallax="10">
                ...
                <li data-transition="fade" data-masterspeed="1000"  >
                    ...
                    <!-- MAIN IMAGE -->
                    <img src="{{asset('theme/images/Slider/h4-1.jpg')}}"  alt=""
                    data-bgposition="center center" data-kenburns="on" data-duration="30000" data-ease="Linear.easeNone" data-scalestart="130" data-scaleend="150" data-bgrepeat="no-repeat" data-bgparallax="10" class="rev-slidebg" data-no-retina>
                    ...
                    <div class="tp-caption heading-2 white-text"
                        ...
                        data-transform_out="y:50px;opacity:0;s:300;"
                        data-start="1400"
                        >premier supplier of quality wood based interiors
                    </div>
                    <!-- LAYER NR. 3 -->
                    <div class="tp-caption btn-1"
                        data-x="center"  data-hoffset="-85"
